...
8: Fix damage received by hostils and players. Currently not adding up correctly with negatives/positives from armor
*/
    ...
    while (battleContinue === true) 
    {
        ...
        for (i=0;i<numPlayers;i++){
            ...
            if (battleContinue === true){
                ...
                // PROBLEM AREA
                //
                document.getElementById("pCombatOutput").a.value += "Hello6" + '\n';
                gameLoop = setInterval(function(){
                    if (pCombatPlayerTargetSelectCheck === true){
                        ...
                        //document.getElementById("pCombatOutput").a.value += "Hello8" + '\n';
                    }
                }, 10);
                //
                // PROBLEM AREA
